...
public class AdminMotelControllerApi {
    ...
    // public ResponseEntity<Map<String, Object>> GetAllRoomStatus(@PathVariable int
    // idmotel) {
    ...
    // public ResponseEntity<Void> postUpdataroomstatus(@PathVariable int
    // idmotelroom, @PathVariable int idstatus,
    ...
    // public ResponseEntity<Void> postUpdataroomstatus2(@PathVariable int
    // idmotelroom, @PathVariable int idstatus) {
    // MotelRoom motelRoom = motelRoomRepository.getById(idmotelroom);
    // RoomStatus roomStatus = roomStatusRepository.getById(idstatus);
    ...
    // public ResponseEntity<Void> postUpdataroomstatus3(@PathVariable int
    // idmotelroom, @PathVariable int idstatus) {
    // MotelRoom motelRoom = motelRoomRepository.getById(idmotelroom);
    // RoomStatus roomStatus = roomStatusRepository.getById(idstatus);
    // motelRoom.setCheckoutdate(null);
